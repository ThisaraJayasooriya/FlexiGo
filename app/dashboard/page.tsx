    ...
    const fetchProfile = async () => {
      try {
        ...
        if (json.profile) {
          ...
          // Initialize analytics/stats if needed here later
        }
      } catch (error) {
  ...
  return (
    <div className="min-h-screen bg-slate-50 pb-24 font-sans antialiased">
      <Header 
        ...
        onProfileClick={() => router.push("/profile/business")}
        onLogout={onLogout} 
      />
      ...
      <main className="max-w-md mx-auto px-5 py-6 space-y-8">
          ...
          <div className="relative z-10 flex flex-col items-start">
            <div>
               ...
               <h2 className="text-4xl font-light text-white tracking-tight leading-tight mb-1">
                 Good <span className="font-bold">{new Date().getHours() < 12 ? "Morning" : new Date().getHours() < 18 ? "Afternoon" : "Evening"}</span>,
               </h2>
        ...
        <div className="grid grid-cols-2 gap-3">
           <div className="bg-white rounded-2xl p-4 shadow-sm border border-slate-100 flex flex-col items-center justify-center text-center">
             ...
             <span className="text-2xl font-bold text-slate-800 leading-none mb-1">0</span>
             <span className="text-[10px] font-semibold text-slate-500 uppercase tracking-wide">Active Jobs</span>
           </div>
           ...
           <div className="bg-white rounded-2xl p-4 shadow-sm border border-slate-100 flex flex-col items-center justify-center text-center">
             ...
             <span className="text-2xl font-bold text-slate-800 leading-none mb-1">0</span>
             <span className="text-[10px] font-semibold text-slate-500 uppercase tracking-wide">Applicants</span>
           </div>
        </div>
        ...
        <div className="grid grid-cols-2 gap-4">
           ...
           >
              ...
              <div className="relative z-10 flex flex-col items-start">
                 ...
                 <h3 className="font-bold text-slate-800 text-sm">My Jobs</h3>
                 <p className="text-xs text-slate-500 mt-0.5">Manage listings</p>
              </div>
           </button>
           ...
           >
              ...
              <div className="relative z-10 flex flex-col items-start">
                 <div className="w-10 h-10 bg-purple-100 text-[#3F72AF] rounded-xl flex items-center justify-center mb-3">
                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" /></svg>
                 </div>
                 <h3 className="font-bold text-slate-800 text-sm">Applications</h3>
                 <p className="text-xs text-slate-500 mt-0.5">Review candidates</p>
              </div>
           </button>
        </div>
  ...
  return (
    <div className="min-h-screen bg-slate-50 pb-24 font-sans antialiased">
      ...
      <Header 
        ...
        userName={profileName || userName}
        userImage={profileImage}
        onProfileClick={() => router.push("/profile/worker")}
        onLogout={onLogout} 
      />
